  ...
  return (
    <div className="w-full">
      ...
      <div className="flex flex-col items-center mb-8">
        <div
          className="w-3/4 h-3 rounded-t-[100%] bg-gradient-to-b from-[#7A241F] to-transparent opacity-70"
          style={{ boxShadow: "0 -8px 30px rgba(30,58,95,0.35)" }}
        />
        <span className="mt-2 text-xs tracking-[0.3em] text-[#7A241F]/70 font-medium">LAYAR</span>
      </div>
